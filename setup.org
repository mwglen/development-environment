...
**** System Info Widget
:PROPERTIES:
:header-args:lua: :tangle (concat (getenv "XDG_CONFIG_HOME") "/conky/sysinfo.lua")
:END:
***** Widget Config
#+begin_src lua
conky.config = {
...
function reset_font()
   return '${font ' .. conky.config.font .. '}${color3}'
end

function h1(name)
   return '${font RobotoMono Nerd Font:bold:size=10}${color3}\n' ..
...
#+begin_src lua
clock_module = [[
${font RobotoMono Nerd Font:size=12}${color3}\
${time %A %d %B}
${font RobotoMono Nerd Font:size=70}${color3}\
${time %H:%M}\
]] .. reset_font() .. '\n\n' .. [[
...
${color green}${if_match ${cpu}<=50}${color4}${cpubar 10,} ${else}${if_match ${cpu}<=70}${color5}${cpubar 10,} ${else}${if_match ${cpu}<=90}${color6}${cpubar 10,} ${else}${if_match ${cpu}>90}${color7}${cpubar 10,}${endif}${endif}${endif}${endif}${color}
...
${voffset 3}$font$color3${top name 1}${goto 110}$color2${top cpu 1}%${goto 165}$color3${top_mem name 1}$color2${goto 270}${top_mem mem_res 1}$color3${top name 2}${goto 110}$color2${top cpu 2}%${goto 165}$color3${top_mem name 2}$color2${goto 270}${top_mem mem_res 2}
