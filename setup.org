...
foreground = ${colors.foreground}
; font-0 = "Ubuntu Nerd Font:size=20:weight=bold;5"
...
picom -b
wal --backend colorthief -i $BACKGROUNDS/nge.jpeg -n
...
*** Configuration
:PROPERTIES:
:header-args:lua: :tangle (concat (getenv "XDG_CONFIG_HOME") "/nvim/init.lua")
:END:
**** Install Packages
#+begin_src lua
-- Install Packages
vim.cmd([[
    ...
    " Setup Neorg (Must run :TSInstall norg)
